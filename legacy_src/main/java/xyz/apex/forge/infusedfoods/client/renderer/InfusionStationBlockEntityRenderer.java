...
public final class InfusionStationBlockEntityRenderer implements BlockEntityRenderer<InfusionStationBlockEntity>
{
	...
	public void renderForGUI(ItemStack stack, InfusionStationBlockEntity blockEntity, float partialTick, PoseStack pose, MultiBufferSource buffer, int combinedLight, int combinedOverlay, ItemDisplayContext displayContext)
	{
