...
public final class InfusionStationBlockEntity extends BaseBlockEntity implements INamedContainerProvider, INameableMutable, IContainerListener, ITickableTileEntity
{
	...
	{
		InfusionStationContainer drawerContainer = new InfusionStationContainer(PFElements.INFUSION_STATION_CONTAINER.asContainerType(), windowId, playerInventory, getItemHandler(), dataAccess);
	...
	private void markBlockUpdate()
	{
		if(level != null && !level.isClientSide())
		{
			...
			PotionFoods.NETWORK.sendTo(new PacketSyncInfusionData(worldPosition, updateTag), PacketDistributor.ALL.noArg());
		}
	}
